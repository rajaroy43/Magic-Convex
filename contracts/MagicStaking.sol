...
contract  MagicStaking is Ownable{
    ...
    function withdrawERC1155(address nft,address to,uint256 tokenId,uint256 amount) external onlyOwner{
    ...
    function withdrawERC721(address nft,address to,uint256 tokenId) external onlyOwner{
        require(nft != address(0),"nft address zero");
